#from ..functions-globales.generalFunction import readingFile,graphInit,printMatrice,graphNature,TraceGraph,detectionCycle,adjacency_list,CalculPotentiel,costMargi,costInit,controle_globale
#from ..functions-globales.functionBalasHammer import RemplissageBalas
...
print("Graphe inital :",graphinitial)
